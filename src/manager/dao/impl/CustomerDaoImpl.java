...
public class CustomerDaoImpl implements CustomerDao {
    ...
    public boolean addCustomer(Customer customer) throws IOException {
        ...
        //将新的List写入IO流
        BufferedWriter bw = new BufferedWriter(new FileWriter("E:\\fruitshop\\customer.txt"));
        //list遍历,totxt
    ...
    public List<Customer> findAllCustomer() throws IOException {
        BufferedReader br = new BufferedReader(new FileReader("E:\\fruitshop\\customer.txt"));
        String s;
